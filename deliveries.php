...
<div class="d-flex flex-wrap align-items-end justify-content-between gap-3 mb-4">
  ...
  <div class="d-flex gap-2">
    <a class="btn btn-soft" href="<?= BASE_URL ?>/delivery_rider/dashboard.php"><i class="bi bi-speedometer2 me-1"></i>Dashboard</a>
  </div>
</div>
              ...
              <tr>
                ...
                <td class="text-end">
                  <div class="d-inline-flex flex-wrap gap-1 justify-content-end">
                    ...
                    <?php endif; ?>
                    <a class="btn btn-sm btn-soft" href="<?= BASE_URL ?>/delivery_rider/proof.php?delivery_id=<?= (int)$d['id'] ?>">Proof</a>
                  </div>
                </td>
              </tr>
            <?php endforeach; ?>
